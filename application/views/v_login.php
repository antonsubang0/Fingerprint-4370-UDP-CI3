...
<body>
        ...
        <div class="bg-white d-flex position-relative"style="background-image: url('<?= base_url();?>/berkas/img/a.svg'); background-repeat: no-repeat; background-size: cover; min-height: 100vh; min-width: 100vw; align-items: center; justify-content: center;">
        <div class="position-absolute" style="right: 10px; bottom: 10px">
            <label style="font-size: 1em; font-weight: bold;">Lubuntu is Open Source (free)</label>
        </div>    
              ...
              <div class="card-body">
                <div class="row">
                    <div class="col-12 col-md-6 align-middle text-center d-none d-md-block">
                        <h3 class="mt-4 mb-4" style="text-shadow: 3px 3px #aaa;">Management Absensi</h3>
                    ...
                    <div class="col-12 col-md-6 align-middle text-center">
                        <div class="card px-3 m-4 shadow position-relative" style="background-image: url('<?= base_url();?>/berkas/img/a.svg'); background-repeat: no-repeat; background-size: 110% auto;">
                                <?php if($this->session->flashdata('info')): ?>
                                    <div class="position-absolute" style="right: -20px; top: -15px;">
                                        <div class="alert alert-danger shadow notif-time" role="alert">
                                          <?= $this->session->flashdata('info'); ?>
                                        </div>
                                    </div>
                                <?php endif; ?> 
                                <div class="position-absolute col-xl-3 col-md-4 col-3 col-sm-2" style="left: -30px; top: -20px;">
                                    <img src="<?= base_url();?>/berkas/img/cpi.jpg" class="img-fluid img-thumbnail rounded-circle shadow">
                                </div>
                            <div class="card-body">
                                <div class="version text-left overflow-auto" style="height: 45vh;">
                                    <button id="closever" class="mb-2">Click Here To Login</button>
                                    <h4>Version 4 Beta</h4>
                                    <ul>
                                        <li>Fix one user can login</li>
                                        <li>Change format on report excel</li>
                                    </ul>
                                    <h4>Version 3 Beta</h4>
                                    <ul>
                                        <li>write changelog</li>
                                    </ul>
                                    <h4>Version 2 Beta</h4>
                                    <ul>
                                        <li>fix form report search to empty</li>
                                        <li>fix layout report</li>
                                    </ul>
                                    <h4>Version 1 Beta</h4>
                                    <ul>
                                        <li>fix form report search</li>
                                        <li>fix add att on report</li>
                                    </ul>
                                </div>
                                <form method="post" class="fpost" action="<?= base_url();?>login/auth">
                                    ...
                                    <div class="row mb-5 mt-4">
                                        <div class="col text-center">
                                            <button type="submit" class="btn btn-primary nav-ajs-cs">Login</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
